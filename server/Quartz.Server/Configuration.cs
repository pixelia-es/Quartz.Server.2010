...
namespace Quartz.Server
{
	...
	public class Configuration
	{
		...
		private const string DefaultServiceName = "QuartzServer(local)";
        private const string DefaultServiceDisplayName = "Quartz Server (local)";
        private const string DefaultServiceDescription = "Quartz Job Scheduling Server (local)";
